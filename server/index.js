...
console.log('Server starting with Firebase Firestore...');
...
// Only start the server when running directly (not imported by Cloud Functions)
if (require.main === module) {
    app.listen(PORT, () => console.log(`Server running on port ${PORT} (Firebase Firestore)`));
}
